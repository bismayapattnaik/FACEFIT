...
import { signupSchema, type SignupInput } from '@mirrorx/shared';
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-midnight flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-gradient-to-br from-midnight via-charcoal/20 to-midnight" />
      <div className="absolute top-1/4 right-1/3 w-64 h-64 bg-gold/5 rounded-full blur-[100px]" />
      ...
      >
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="font-orbitron text-2xl font-bold text-gold">MirrorX</span>
          </Link>
        </div>
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Start your virtual try-on journey</CardDescription>
          </CardHeader>
